...
const minePage = StyleSheet.create({
    ...
    nameId:{position:'absolute', left:30, bottom:8, backgroundColor:"transparent", },
...
const pageVip = StyleSheet.create({
    ...
    vipTextRowView:{flexDirection:'row', padding:5, justifyContent:'space-between', backgroundColor:"transparent" },
