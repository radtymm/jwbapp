...
const pageLuck = StyleSheet.create({
    ...
    bottomView:{borderWidth:2, borderTopWidth:0, borderColor:"#ebebeb",shadowColor:"#ebebeb", shadowRadius:setScaleSize(4), shadowOffset:{width:setScaleSize(4), height:setScaleSize(2),}, width:setScaleSize(660), height:setScaleSize(20), backgroundColor:"#fff", borderBottomLeftRadius:setScaleSize(8),  borderBottomRightRadius:setScaleSize(8),},
