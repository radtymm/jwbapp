...
const pageLuck = StyleSheet.create({
    ...
    ageView:{backgroundColor:"#669ce3", height:setScaleSize(36), borderRadius:setScaleSize(4), paddingLeft:setScaleSize(16), paddingRight:setScaleSize(16)},
    liveView:{marginLeft:setScaleSize(10), marginRight:setScaleSize(10), backgroundColor:"#ffb234", height:setScaleSize(36), borderRadius:setScaleSize(4), paddingLeft:setScaleSize(16), paddingRight:setScaleSize(16)},
...
const PagePerInfo = StyleSheet.create({
    ...
    picker:{ width:120, height:40, flex:1, justifyContent:"flex-end", alignItems:'flex-end', color:"rgb(85, 85, 85)",},
    pickerItem:{width:30},
